...
public class DmHospitalDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dm_hospital_detail);
...
// 3. 병원 이름, 별점, 찜 버튼 설정
        ...
        textHospitalName.setText("디엠 성형외과");
        textRating.setText("★ 9.4");

        HospitalData babaHospital = new HospitalData("디엠성형외과", R.drawable.dm_1);
...
// 지도 이미지 클릭 시 구글맵 이동
        imageMapPreview.setOnClickListener(v -> {
            Uri gmmIntentUri = Uri.parse("geo:0,0?q=서울 강남구 압구정로 158 (신사동, 진우빌딩) 2층");
        ...
        showMore.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(DmHospitalDetailActivity.this, ReviewMoreActivity.class);
            intent.putExtra("hospitalName", "디엠성형외과");
        ...
        List<DoctorData> doctors = Arrays.asList(
                new DoctorData(
                        "이주홍",
                        R.drawable.doctor_dm_park,
                        Arrays.asList("눈성형", "코성형")
                )
        );
        ...
        List<Integer> imageResIds = Arrays.asList(
                R.drawable.dm_1, R.drawable.dm_2, R.drawable.dm_3, R.drawable.dm_4,
                R.drawable.dm_5, R.drawable.dm_6
