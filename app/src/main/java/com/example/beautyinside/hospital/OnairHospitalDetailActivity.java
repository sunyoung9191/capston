...
public class OnairHospitalDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_onair_hospital_detail);
        ...
        textHospitalName.setText("온에어 성형외과");
        textRating.setText("★ 9.8");

        // 병원 정보 정의 (이름 + 배너 이미지 ID)
        HospitalData amondHospital = new HospitalData("온에어 성형외과", R.drawable.onair_1);
...
// 하트 클릭 시 동작
        ...
        List<Integer> imageResIds = Arrays.asList(
                R.drawable.onair_1, R.drawable.onair_2
        ...
        showMore.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(OnairHospitalDetailActivity.this, ReviewMoreActivity.class);
            intent.putExtra("hospitalName", "온에어성형외과");
...
// 지도 이미지 클릭 시 구글맵 이동
        imageMapPreview.setOnClickListener(v -> {
            Uri gmmIntentUri = Uri.parse("geo:0,0?q=서울 강남구 강남대로 422 (역삼동) 씨티빌딩 6층");
