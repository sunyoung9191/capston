...
public class YellowHospitalDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yellow_hospital_detail);
        ...
        textHospitalName.setText("옐로우 성형외과");
        textRating.setText("★ 9.8");

        // 병원 정보 정의 (이름 + 배너 이미지 ID)
        HospitalData amondHospital = new HospitalData("옐로우 성형외과", R.drawable.yellow_1);
...
// 지도 이미지 클릭 시 구글맵 이동
        imageMapPreview.setOnClickListener(v -> {
            Uri gmmIntentUri = Uri.parse("geo:0,0?q=서울 강남구 강남대로 406 (역삼동, GLASS TOWER) 글라스타워 5층, 501-1호");
        ...
        List<Integer> imageResIds  = Arrays.asList(
                R.drawable.yellow_1, R.drawable.yellow_2, R.drawable.yellow_3, R.drawable.yellow_4,
                R.drawable.yellow_5, R.drawable.yellow_6
        ...
        showMore.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(YellowHospitalDetailActivity.this, ReviewMoreActivity.class);
            intent.putExtra("hospitalName", "옐로우성형외과");
