...
public class NanaHospitalDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nana_hospital_detail);
        ...
        textHospitalName.setText("나나 성형외과");
        textRating.setText("★ 9.6");

        // 병원 정보 정의 (이름 + 배너 이미지 ID)
        HospitalData amondHospital = new HospitalData("나나 성형외과", R.drawable.nana_1);
...
// 하트 클릭 시 동작
        ...
        List<Integer> imageResIds = Arrays.asList(
                R.drawable.nana_1, R.drawable.nana_2, R.drawable.nana_3, R.drawable.nana_4,
        ...
        List<DoctorData> doctors = Arrays.asList(
                new DoctorData(
                        "최정식",
                        R.drawable.doctor_nana_park,
                        Arrays.asList("눈성형", "코성형","가슴성형","지방성형")
                ),
                new DoctorData(
                        "위성재",
        ...
        showMore.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(NanaHospitalDetailActivity.this, ReviewMoreActivity.class);
            intent.putExtra("hospitalName", "나나성형외과");
...
// 지도 이미지 클릭 시 구글맵 이동
        imageMapPreview.setOnClickListener(v -> {
            Uri gmmIntentUri = Uri.parse("geo:0,0?q=서울 강남구 강남대로 492 (논현동, 한맥빌딩) HM타워 2~10층, 12~13층");
