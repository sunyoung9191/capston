...
public class ThankyouHospitalDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thankyou_hospital_detail);
        ...
        textHospitalName.setText("땡큐 성형외과");
        textRating.setText("★ 9.1");


        // 병원 정보 정의 (이름 + 배너 이미지 ID)
        HospitalData amondHospital = new HospitalData("땡큐 성형외과", R.drawable.thankyou_1);
...
// 지도 이미지 클릭 시 구글맵 이동
        imageMapPreview.setOnClickListener(v -> {
            Uri gmmIntentUri = Uri.parse("geo:0,0?q=서울 강남구 강남대로 446 (역삼동, 한웰빌딩) 한웰빌딩(나이키건물)  5층, 8층, 9층 (접수: 9층) 땡큐성형외과의원(피부과진료) ");
        ...
        List<Integer> imageResIds  = Arrays.asList(
                R.drawable.thankyou_1, R.drawable.thankyou_2, R.drawable.thankyou_3, R.drawable.thankyou_4,
                R.drawable.thankyou_5, R.drawable.thankyou_6
        ...
        List<DoctorData> doctors = Arrays.asList(
                new DoctorData(
                        "김형석",
                        R.drawable.doctor_thankyou_park,
                        Arrays.asList("눈성형", "코성형","안면윤곽/양악","필러")
                )
        );
        ...
        showMore.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(ThankyouHospitalDetailActivity.this, ReviewMoreActivity.class);
            intent.putExtra("hospitalName", "땡큐성형외과");
