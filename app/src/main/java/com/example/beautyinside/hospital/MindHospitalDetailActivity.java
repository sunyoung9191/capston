...
public class MindHospitalDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mind_hospital_detail);
        ...
        textHospitalName.setText("마인드 성형외과");
        textRating.setText("★ 9.0");

        HospitalData babaHospital = new HospitalData("마인드성형외과", R.drawable.mind_1);
...
// 지도 이미지 클릭 시 구글맵 이동
        imageMapPreview.setOnClickListener(v -> {
            Uri gmmIntentUri = Uri.parse("geo:0,0?q=서울 서초구 강남대로 519 (반포동, 도충빌딩) 도충빌딩 7층 마인드성형외과");
        ...
        List<DoctorData> doctors = Arrays.asList(
                new DoctorData(
                        "이현건",
                        R.drawable.doctor_mind_park,
                        Arrays.asList("눈성형", "코성형","지방성형")
                )
        );
        ...
        showMore.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(MindHospitalDetailActivity.this, ReviewMoreActivity.class);
            intent.putExtra("hospitalName", "마인드성형외과");
