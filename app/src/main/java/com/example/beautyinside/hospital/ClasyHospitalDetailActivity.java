...
public class ClasyHospitalDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clasy_hospital_detail);
        ...
        textHospitalName.setText("클래시 성형외과");
        textRating.setText("★ 9.2");

        HospitalData babaHospital = new HospitalData("클래시성형외과", R.drawable.clasy_1);
...
// 지도 이미지 클릭 시 구글맵 이동
        imageMapPreview.setOnClickListener(v -> {
            Uri gmmIntentUri = Uri.parse("geo:0,0?q=서울 서초구 서초대로77길 24 (서초동, 강남 지웰타워2) 12층");
        ...
        List<DoctorData> doctors = Arrays.asList(
                new DoctorData(
                        "박성훈",
                        R.drawable.doctor_clasy_park,
                        Arrays.asList("눈성형", "코성형","안면윤곽/양악","가슴성형","필러")
                )
        );
        ...
        showMore.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(ClasyHospitalDetailActivity.this, ReviewMoreActivity.class);
            intent.putExtra("hospitalName", "클래시성형외과");
        ...
        List<Integer> imageResIds = Arrays.asList(
                R.drawable.clasy_1, R.drawable.clasy_2, R.drawable.clasy_3, R.drawable.clasy_4,
                R.drawable.clasy_5, R.drawable.clasy_6
