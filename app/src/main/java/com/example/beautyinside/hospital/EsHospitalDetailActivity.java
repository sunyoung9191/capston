...
public class EsHospitalDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_es_hospital_detail);
        ...
        textHospitalName.setText("이에스 성형외과");
        textRating.setText("★ 9.6");

        HospitalData babaHospital = new HospitalData("이에스성형외과", R.drawable.es_1);
        ...
        List<DoctorData> doctors = Arrays.asList(
                new DoctorData(
                        "이준호",
                        R.drawable.doctor_es_park,
                        Arrays.asList("눈성형", "코성형","리프팅","가슴성형","피부")
                )
        );
...
// 지도 이미지 클릭 시 구글맵 이동
        imageMapPreview.setOnClickListener(v -> {
            Uri gmmIntentUri = Uri.parse("geo:0,0?q=서울 강남구 도산대로 435 (청담동, 삼이빌딩) 2,6층 (삼이빌딩)");
        ...
        List<Integer> imageResIds = Arrays.asList(
                R.drawable.es_1, R.drawable.es_2, R.drawable.es_3, R.drawable.es_4,
                R.drawable.es_5, R.drawable.es_6
        ...
        showMore.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(EsHospitalDetailActivity.this, ReviewMoreActivity.class);
            intent.putExtra("hospitalName", "이에스성형외과");
